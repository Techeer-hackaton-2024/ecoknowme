...
router.get("/api/makeProblem", (req, res) =>{
...
// router.get("/knock", function(req, res){
//   res.render('door');
// })
...
// router.get("/kimkilgu", function(req, res){
// 	res.render('kimkilgu');
// })
...
//   res.render('circle');
// })
// router.get("/pudding", function(req, res){
//   res.render('rect1');
// })
...
//   res.render('circle1');
// })
// router.get("/rect1", function(req, res){
//   res.render('rect1');
// })
...
//     res.render('todo');
// })
// router.get("/snakegame", function(req, res){
...
// router.get("/colorful", function(req, res){
//   res.render('color');
// })
...
// '쁐쁐','ㄱㅂㄹㅌ','프','픅','픆','픇','픈','픉','픊','픋','플','픍','픎','픏','픐','픑','픒','픓','픔','픕','픖','픗','픘','픙','픚','픛','픜','픝','픞','픟'
// ];
...
// '붓x4 X','걡','뜨','뜩','뜪','뜫','뜬','뜭','뜮','뜯','뜰','뜱','뜲','뜳','뜴','뜵','뜶','뜷','뜸','뜹','뜺','뜻','뜼','뜽','뜾','뜿','띀','띁','띂','띃'
// ];
...
//   console.log('Converted Text: ' + query1);
